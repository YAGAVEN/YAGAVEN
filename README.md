...
I am a **3rd Year AI & Data Science Student** at **RMK College of Engineering and Technology** with a passion for building real-world projects and developing innovative full-stack applications. I have a strong interest in AI model building and focus on writing optimized, efficient, and scalable code.

- 🔭 Currently pursuing **B.Tech in Artificial Intelligence and Data Science** (CGPA: 8.27)
- 🌱 Exploring emerging technologies and AI/ML models
- 💡 Love problem-solving and adapting to new technologies
- 🎯 Focus on building scalable and efficient applications
- 📍 Based in Andarkuppam, Ponneri, Tamil Nadu

## 🏆 Achievements

- 🥈 **First Runner-up** - National-level Cyber Shield Hackathon, Jabalpur
- 🏅 **10th Prize** - CodeCraft, 24-hour hackathon at Sairam Engineering College

## 💼 Internships

### Data Analyst @ LUMINANT WORKS
📍 Near Ambattur IT Park (On-Site) | ⏱️ 1 Month
...
- 🎓 **NPTEL** - Cloud Computing, Soft Skills
- 💻 **Skill Rack** - 7+ Certifications
- 🗃️ **LeetCode** - 50+ SQL Problems
- 🏢 **Infosys** - C, C++ Certifications
...
![Profile Views](https://komarev.com/ghpvc/?username=YAGAVEN&color=blue&style=flat-square)
...
⭐️ From [Yagaven S](https://yagaven.me)
